...
```js
https://cdn.jsdelivr.net/gh/hchiam/canvas-converse@3.6.0/script.js
```

## Example usage

```js
import { CanvasConverse } from "https://cdn.jsdelivr.net/gh/hchiam/canvas-converse@3.6.0/script.js";
...
```html
<script
  src="https://cdn.jsdelivr.net/gh/hchiam/canvas-converse@3.6.0/script.js"
  integrity="sha384-V6wspJyYFmBEsN+o60tdTv4uNv5ygRLeEENh88gowdMhQEPTCjg2/oxEguyIjwW+"
